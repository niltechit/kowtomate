...
namespace KowToMateAdmin.Helper
{
	public static class IJSRuntimeExtensions
	{
		...
		public static ValueTask ShowToast(this IJSRuntime js, SweetAlertTypeMessagee type, string message, string title = "")
		{
			return js.InvokeVoidAsync("showToast", type.ToString().ToLower(), message, title);
		}
	}
