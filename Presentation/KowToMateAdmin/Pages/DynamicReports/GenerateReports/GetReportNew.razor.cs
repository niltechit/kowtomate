...
namespace KowToMateAdmin.Pages.DynamicReports.GenerateReports
{
    public partial class GetReportNew
    {
        ...
        private List<GridViewSetupColumnSlimModel> selectedGridViewSetupColumn = new List<GridViewSetupColumnSlimModel>();
        ...
        async Task openGridViewTemplateManage()
        {
            ...
            var newTableColumns = new List<GridViewSetupColumnSlimModel>();
            ...
            foreach (var columnId in dynamicReportPagePropertyVM.selectedTableColumnIds)
            {
                ...
                newTableColumns.Add(new GridViewSetupColumnSlimModel { ColoumnId = columnId, Width = Convert.ToDouble(tableColumn.Width), DisplayOrder = (int)tableColumn.DisplayOrder });
            }
