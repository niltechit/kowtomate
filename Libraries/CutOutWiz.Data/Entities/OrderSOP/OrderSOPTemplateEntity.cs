...
{
	public class OrderSOPTemplateEntity
	{
		...
		//public List<OrderSOPTemplateServiceModel> OrderSopTemplateServiceList { get; set; } = new List<OrderSOPTemplateServiceModel>();
		//public List<OrderSOPStandardServiceModel> OrderSopStandardServiceList { get; set; } = new List<OrderSOPStandardServiceModel>();
