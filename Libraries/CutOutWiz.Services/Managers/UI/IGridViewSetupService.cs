...
namespace CutOutWiz.Services.UI
{
    public interface IGridViewSetupService
    {
        ...
        Task<List<GridViewSetupColumnSlimModel>> GetColumnsByGridViewSetupId(int gridViewSetupId);
        ...
        Task<Response<bool>> TemplateColumnsInsertOrUpdateBySetupId(int gridViewSetupId, List<GridViewSetupColumnSlimModel> columns);
